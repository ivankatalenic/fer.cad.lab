...
namespace Optimization {
	...
	/// @brief Finds the minimum with the respect to the bounds and constraints.
	/// @param f Multivariable function that's being minimized.
	/// @param bound_lower Column of lower bounds that must be satisfied.
	/// @param bound_upper Column of upper bounds that must be satisfied.
	/// @param constraints 
	/// @param start 
	/// @param epsilon 
	/// @param alpha 
